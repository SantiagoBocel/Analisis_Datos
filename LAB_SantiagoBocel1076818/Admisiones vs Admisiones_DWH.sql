...
--------------------------------------------------------------------------------------------
	...
	set statistics io on
		...
		from	Admisiones_DWH.Fact.Examen as e inner join
				...
				Admisiones_DWH.Dimension.Fecha as f on e.DateKey = f.DateKey inner join
				Admisiones_DWH.Dimension.Materia as m on m.SK_Materia = e.SK_Materia inner join
				Admisiones_DWH.Dimension.Descuento as d on d.SK_Descuento = e.SK_Descuento
...
--------------------------------------------------------------------------------------------
	...
	--Resultados 
	--Al Comparar el Resultado obtenido por Exclution plan se puede notar que el costo del Query es menor en el DWH
	--¿Cuál es mejor?
	--- Se puede decir que el DWH es mejor ya que al tener los datos en modelo de estrella las dimensiones no tienen jerarquia ya que todas apuntan al centro