...
--Metadata
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension materia provee una vista desnormalizada de las tablas origen materia y examen en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension carrera provee una vista desnormalizada de las tablas origen Descuento y Examen en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
...
--Transformación en modelo lógico (mas detalles)
	...
	ALTER TABLE Dimension.Descuento ADD Descripcion[UDT_Varcharlargo]
...
--Dimensiones
	...
	From Admisiones.DBO.Descuento D
